       ...
       <form className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex flex-col flex-1 gap-2'>
              ...
              <div className='flex gap-4'>
                ...
                <button className=' flex p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80'>Upload</button>
              </div>
        ...
        <div className='flex justify-center '>
         <button className='my-7 p-5 bg-slate-700 text-white rounded-lg uppercase hover:opacity-90 disabled:opacity-80 '>create listing</button>
        </div>
        </div>
      </main>
  )
